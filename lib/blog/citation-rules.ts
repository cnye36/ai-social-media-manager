...
- Internal links from the provided index must also be inline with natural anchor text woven into the sentence. Use the exact full URL from the index (must include /blog/ in the path when linking to blog posts).
